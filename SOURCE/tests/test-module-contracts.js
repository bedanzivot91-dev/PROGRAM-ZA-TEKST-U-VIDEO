...
const contracts = [
  ...
  ['image-generation-provider.js', ['buildFinalImagePrompt', 'buildImageGenerationRequest']],
  ['karaoke-engine.js', ['estimateWordTimings', 'buildKaraokeFrame']],
  ['location-registry.js', ['createLocationRegistry', 'getLocation']],
  ['locked-identity-text.js', ['POSITIVE', 'NEGATIVE', 'CHARACTER_ID']],
  ['lyrics-alignment.js', ['alignLyricsToAsr']],
  ['lyrics-line-breaker.js', ['breakLyricsLine']],
  ['lyrics-overlay-storage.js', ['saveOverlayProject', 'loadOverlayProject']],
  ['lyrics-parser.js', ['parseLyrics']],
  ['music-analysis.js', ['analyzeMusic']],
  ['project-backup.js', ['createBackup', 'listBackups']],
  ['project-export.js', ['exportProject']],
  ['project-status.js', ['getProjectStatus']],
  ...
  ['text-video-tools.js', ['parseLrc', 'exportLrc', 'parseSrt', 'buildBatchExportPlan']],
  ...
  ['wardrobe-registry.js', ['createWardrobeRegistry', 'validateWardrobeDiversity']]
];
